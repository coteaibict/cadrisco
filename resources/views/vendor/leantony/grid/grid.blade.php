        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                    ...
                    <div class="pull-right">
                        <b>
                            @if($grid->getData()->total() <= $grid->getData()->perpage())
                                Exibindo {{ ($grid->getData()->currentpage() -1 ) * $grid->getData()->perpage() + 1 }}
                                de {{ $grid->getData()->total() }}
                                total de {{ $grid->getData()->total() }} registros.
                            @else
                                Exibindo {{ ($grid->getData()->currentpage() -1 ) * $grid->getData()->perpage() + 1 }}
                                de {{ $grid->getData()->currentpage() * $grid->getData()->perpage() }}
                                total de {{ $grid->getData()->total() }} registros.
                            @endif
                        </b>
                    </div>
                @else
                    <div class="pull-right">
                        <b>
                            exibindo {{ $grid->getData()->count() }} registros.
                        </b>
                    </div>
                @endif
                    ...
                    @if($grid->hasItems())
                        @if($grid->warnIfEmpty())
                            <div class="alert alert-warning">
                                <strong><i class="fa fa-exclamation-triangle"></i>&nbsp;Nenhum resultado!</strong>
                            </div>
                        @endif
                    @else
