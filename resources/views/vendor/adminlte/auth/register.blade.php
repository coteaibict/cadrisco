            ...
            <div class="register-box-body">
                ...
                <form action="{{ url('/register') }}" method="post">
                    ...
                    <div class="form-group has-feedback">
                        <input type="text" class="form-control" required="required" placeholder="{{ trans('adminlte_lang::message.fullname') }}" name="name" value="{{ old('name') }}" autofocus/>
                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                    </div>
                    <div class="form-group has-feedback">
                        <input type="text" class="form-control" required="required" placeholder="{{ trans('adminlte_lang::message.cpf') }}" name="cpf" id="cpf" value="{{ old('cpf') }}"/>
                    ...
                    @endif
                    <div class="form-group has-feedback">
                        <input type="email" class="form-control" required="required" placeholder="{{ trans('adminlte_lang::message.email') }}" name="email" value="{{ old('email') }}"/>
                    ...
                    <div class="form-group has-feedback">
                        <input type="password" class="form-control" required="required" placeholder="{{ trans('adminlte_lang::message.retypepassword') }}" name="password_confirmation"/>
